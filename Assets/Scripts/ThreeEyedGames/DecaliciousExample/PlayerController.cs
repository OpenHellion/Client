...
namespace ThreeEyedGames.DecaliciousExample
{
	public class PlayerController : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			RaycastHit hitInfo;
			if (Input.GetKeyDown(KeyCode.E) && Physics.Raycast(Camera.main.ViewportPointToRay(Vector3.one * 0.5f), out hitInfo))
			{
				bool flag = false;
				...
				AudioSource.PlayClipAtPoint((!flag) ? InteractError : InteractSuccess, base.transform.position + base.transform.forward * 0.5f);
			}
