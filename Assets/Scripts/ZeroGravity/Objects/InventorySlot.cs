...
namespace ZeroGravity.Objects
{
	public class InventorySlot : IItemSlot
	{
		...
		public InputManager.AxisNames? ShortcutKey { get; private set; }
		...
		public InventorySlot(Outfit outfit, short slotID, Type type, Size size, Group group, InputManager.AxisNames? shortKey, int cycleIndex, bool mustBeEmptyToRemove, Item item, List<AttachData> points, Inventory inv)
		{
			SlotID = slotID;
			slotType = type;
			slotSize = size;
