...
/////// Diffuse:
                ...
                float3 diffuseColor = lerp(lerp(lerp((saturate((1.0-(1.0-_node_6067_var.rgb)*(1.0-_ReflectionTex_var.rgb)))*0.8),_MainTex_var.rgb,_Transparency_var),_MainTex_var.rgb,saturate(pow((i.vertexColor.r+(i.vertexColor.r*_HeightTex_var.rgb)),1.2))),(_MainTex_var.rgb*0.2),i.vertexColor.g);
